                            ...
                            'clientEvents' => [
                                    'fileuploaddone' => 'function(e, data) {
                                        ...
                                        $.each(data.result.files, function( index, value ){
                                            console.log(value);
                                            $("#fileGridManager .row").prependTo(\'<div class="col-xs-6 col-sm-4 col-md-3 image-thumbnail"><a class="thumbnail" href="' . Url::to(['view']) . '?id=\' + value.id + \'" data-id="\' + value.id + \'"><span>\' + value.id + \'</span><img src="\' + value.thumbnailUrl + \'"></a></div>\');
